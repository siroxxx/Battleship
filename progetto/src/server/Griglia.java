...
public class Griglia {
    ...
    public void creanavi(Integer[] messaggio) {
        List<Integer> nave1xtemp = new ArrayList<Integer>(); // creo delle navi temporanee in formato lista perchè più
                                                             // comodo
        ...
        for (int i = 0; i < messaggio.length; i++) { // in questo for salvo le coordinate nei vettori delle navi
                                                     // decrementando la i
    ...
    public void creacampo() { // per ogni nave metto lo stato corrispondente della casella nella griglia->
                              // stato 2: nave presente non colpita
    ...
    public Boolean[] spara(Integer[] dati) { // metodo generale che gestisce lo sparo di colpi singoli, bombe e poteri
                                             // speciali
